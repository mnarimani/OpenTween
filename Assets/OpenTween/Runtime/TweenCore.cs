...
namespace OpenTween
{
    ...
    ///
    /// Thankfully frameworks like XNA and Unity provide lerp functions on their primitive Mathf types
        ...
        where T : struct
    {
        ...
        /// </summary>
        public T StartValue { get { return start; } set { start = value; } }

        /// <summary>
        /// Gets the ending value of the tween.
        /// </summary>
        public T EndValue { get { return end; } set { end = value; } }
