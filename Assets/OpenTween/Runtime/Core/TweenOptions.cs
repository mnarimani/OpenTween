...
namespace OpenTween
{
    ...
    public class TweenOptions<T> : IOptionsBase
    {
        ...
        public TweenOptions(T start, T end, float duration, Ease ease = EaseMap.Default) : this()
        {
            _start = start;
            _end = end;
            _ease = ease;
        ...
        public EaseFunc CustomEase { get => _customEase; set => _customEase = value; }
